...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCANThreadENDCLASS_t qt_meta_stringdata_CLASSCANThreadENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 15),  // "getProtocolData"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 12),  // "VCI_CAN_OBJ*"
        QT_MOC_LITERAL(40, 3),  // "vci"
        QT_MOC_LITERAL(44, 5),  // "dwRel"
        QT_MOC_LITERAL(50, 9),  // "boardInfo"
        QT_MOC_LITERAL(60, 14),  // "VCI_BOARD_INFO"
        QT_MOC_LITERAL(75, 3)   // "vbi"
    },
    "CANThread",
    "getProtocolData",
    "",
...
void CANThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->getProtocolData((*reinterpret_cast< std::add_pointer_t<VCI_CAN_OBJ*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint>>(_a[2]))); break;
        ...
        {
            using _t = void (CANThread::*)(VCI_CAN_OBJ * , unsigned int );
...
// SIGNAL 0
void CANThread::getProtocolData(VCI_CAN_OBJ * _t1, unsigned int _t2)
{
